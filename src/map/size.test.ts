import { SizedLRUItem } from '../entry';
import { SizeBasedLRUMap } from './size';

describe('Size based LRU Map', () => {
  ...
  test('should not accept item larger than maxSize', () => {
    ...
    expect(() => map.set('one', { value: 1, size: 2048 })).toThrowError();
  });
